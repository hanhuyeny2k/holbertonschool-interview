#!/usr/bin/python3
'''
Given a set of consecutive integers starting from 1 up to and including n, the
players take turns choosing a prime number from the set and removing that
number and its multiples from the set. The player that cannot make a move loses
the game.
'''
